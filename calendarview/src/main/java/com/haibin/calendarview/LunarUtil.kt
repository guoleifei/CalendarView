...
internal object LunarUtil {
    ...
    private fun solarToInt(y: Int, m: Int, d: Int): Long {
        ...
        tempM = (tempM + 9) % 12
        tempY -= tempM / 10
        return (365 * tempY + tempY / 4 - tempY / 100 + tempY / 400 + (tempM * 306 + 5) / 10 + (d - 1)).toLong()
    }
